...
def detect_curve(
    ...
    """
    Detect a curve by comparing nearest vs farthest slice positions.
    Uses the average shift of both yellow and white lines.
    Returns (is_curve, direction) where direction: +1 = right, -1 = left, 0 = none.
    Ported from https://github.com/Qristine0/duckieBckp
    """
    shifts = []
